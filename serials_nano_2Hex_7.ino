...
int maximumPWMFeedback = 1510; //1972 highest measured;
int minimumPWMFeedback = 485; //625 lowest measured;
...
int maximumPWMOutput = 1500; //1475 highest working, but sometimes errors
