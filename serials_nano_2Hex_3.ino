...
int maximumPWMFeedback = 1480; //1972 highest measured;
int minimumPWMFeedback = 470; //625 lowest measured;
...
int maximumPWMOutput = 1470; //1475 highest working, but sometimes errors
